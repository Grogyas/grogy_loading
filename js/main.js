...
(function(window, undefined) {
    ...
    AP.init({
      playList: [
        {'icon': iconImage, 'title': "", 'file': './audio/1.mp3'},
        {'icon': iconImage, 'title': '', 'file': './audio/2.mp3'},
        {'icon': iconImage, 'title': '', 'file': './audio/3.mp3'},
        {'icon': iconImage, 'title': '', 'file': './audio/4.mp3'},
        {'icon': iconImage, 'title': '', 'file': './audio/5.mp3'}
      ]
    });
